...
const Dashboard = () => {
  ...
  const handleLogout = async () => {
    const result = await Swal.fire({
      ...
      confirmButtonColor: "#6C63FF", // Updated to match the new palette
      cancelButtonColor: "#FF6584", // Soft pink for cancel
      ...
      <div className="min-h-screen bg-gradient-to-br from-sky-50 to-rose-50 relative">
        ...
        >
          <ul className="p-4 space-y-1">
            ...
            <li className="hover:bg-indigo-50 p-3 rounded-lg cursor-pointer text-gray-700 hover:text-indigo-600 transition-colors flex items-center gap-2">
              <svg className="w-5 h-5 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
